...
Layer composition: resolving a base definition plus ordered layer patches into a single
`EffectiveTemplate`, deterministically and with a stable content hash.
